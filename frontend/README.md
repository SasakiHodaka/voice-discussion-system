...
frontend/openapi.json を公式仕様に合わせて編集します。
...
src/client/ 配下に types.gen.ts, sdk.gen.ts, @tanstack/react-query.gen.ts などが公式仕様で生成されます。

### 3. 生成物の利用

src/lib/api.ts などから公式APIクライアントをインポートして利用します。
